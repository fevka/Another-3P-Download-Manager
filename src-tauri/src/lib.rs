...
<a href="https://fuckingfast.co/86skntewlrun#brazilian.bin.part1.rar" target="_blank" rel="noopener nofollow">brazilian part1</a>
    ...
    fn extracts_updates_from_green_div() {
        let html = r#"<h3>Example Updates &#8211; Direct Links only</h3>
<div style="background-color: #9aff612e; border: 1px solid #159311; border-radius: 10px; padding:20px; margin-bottom: 20px">
<ol>
<li><a href="https://filecrypt.cc/Container/DB6F829416.html">Example File 1 (3 parts)</a><br />
or<br />
<a href="https://filecrypt.cc/Container/68C5B68CB1.html">Example File 2 (2 parts)</a></p>
<li><a href="https://filecrypt.cc/Container/6185D28BB9.html">Example File 3 (2 parts)</a>
</ol>
</div>"#;
        let entries = parse_updates_from_page(html);
        assert_eq!(entries.len(), 3);
        assert_eq!(entries[0].name, "Example File 1 (3 parts)");
